          ...
          <Row>
            ...
            <Col md={3}>
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>Цена: {product.price} Тг.</ListGroup.Item>
                <ListGroup.Item>
            ...
            <Col md={3}>
              <Card>
                <ListGroup variant='flush'>
                  ...
                  <ListGroup.Item>
                    <Row>
                      <Col>Есть в наличии:</Col>
                      <Col>
                        {product.countInStock > 0 ? 'Есть' : 'Нету'}
                      </Col>
                    </Row>
                  </ListGroup.Item>
              ...
              <ListGroup variant='flush'>
                ...
                <ListGroup.Item>
                  ...
                  {userInfo ? (
                    ...
                    <Message>
                      Пожалуйста, <Link to='/login'>войдите</Link> чтоб написать отзыв{' '}
                    </Message>
                  )}
                </ListGroup.Item>
              </ListGroup>
